...
export default function SignIn() {
  ...
  >
    ...
    <div className="text-xs opacity-80 text-center">
      <button type="submit" type="button" onClick={forgotPassword} className="underline">Forgot password?</button>
    </div>
  </AuthLayout>
  );
}
